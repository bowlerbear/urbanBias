...
setwd("C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/amphibians")

### read in dataset ###################################

unzip("0026201-210914110416597.zip", list=TRUE) 

data <- readr::read_delim(unzip("0026201-210914110416597.zip", 
                                "occurrence.txt"),
                          delim="\t")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/recorders_revision_Obs_amphibians.rds")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/mtbqs_revision_Obs_amphibians.rds")
...
saveRDS(surveys,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/surveys_revision_Obs_amphibians.rds")
