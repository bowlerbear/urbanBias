...
setwd("C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/GBIF/amphibians")

### read in bird dataset ###################################

unzip("0026198-210914110416597.zip", list=TRUE) 

data <- readr::read_delim(unzip("0026198-210914110416597.zip", 
                                "occurrence.txt"),
                          delim="\t")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/GBIF/recorders_revision_GBIF_amphibians.rds")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/GBIF/mtbqs_revision_GBIF_amphibians.rds")
...
saveRDS(surveys,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/GBIF/surveys_revision_GBIF_amphibians.rds")
