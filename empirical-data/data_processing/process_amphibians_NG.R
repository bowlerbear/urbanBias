...
setwd("C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/NG/amphibians")

### read in dataset ###################################

unzip("0026203-210914110416597.zip", list=TRUE) 

data <- readr::read_delim(unzip("0026203-210914110416597.zip", 
                                "occurrence.txt"),
                          delim="\t")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/NG/recorders_revision_NG_amphibians.rds")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/NG/mtbqs_revision_NG_amphibians.rds")
...
saveRDS(surveys,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/NG/surveys_revision_NG_amphibians.rds")
