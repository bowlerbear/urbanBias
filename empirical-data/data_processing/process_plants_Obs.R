...
setwd("C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/plants")

### read in bird dataset ###################################

unzip("0022465-210914110416597.zip", list=TRUE) 

data <- readr::read_delim(unzip("0022465-210914110416597.zip", 
                                "occurrence.txt"),
                          delim="\t")
...
dat <- data %>%
  select(species, year,month,day,eventDate,class,phylum,
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/recorders_revision_Obs_plants.rds")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/mtbqs_revision_Obs_plants.rds")
...
saveRDS(surveys,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/observation.org/surveys_revision_Obs_plants.rds")
