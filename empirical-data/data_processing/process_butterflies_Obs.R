...
setwd("C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/butterflies")

### read in bird dataset ###################################

unzip("0022441-210914110416597.zip", list=TRUE) 

data <- readr::read_delim(unzip("0022441-210914110416597.zip", 
                                "occurrence.txt"),
                          delim="\t")
...
dat <- data %>%
  select(species, year,month,day,eventDate,class,order,
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/recorders_revision_Obs_butterflies.rds")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Obs/mtbqs_revision_Obs_butterflies.rds")
...
saveRDS(surveys,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/observation.org/surveys_revision_Obs_butterflies.rds")
