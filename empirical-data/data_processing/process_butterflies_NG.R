...
setwd("C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/NG/butterflies")

### read in bird dataset ###################################

unzip("0022419-210914110416597.zip", list=TRUE) 

data <- readr::read_delim(unzip("0022419-210914110416597.zip", 
                                "occurrence.txt"),
                          delim="\t")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/NG/recorders_revision_NG_butterflies.rds")
...
#save as data frame
saveRDS(annualRecorders,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/NG/mtbqs_revision_NG_butterflies.rds")
...
saveRDS(surveys,file="C:/Users/db40fysa/Nextcloud/sMon/sMon-Analyses/GBIF_other_data/urbanBias_datasets/Naturgucker/surveys_revision_NG_butterflies.rds")
